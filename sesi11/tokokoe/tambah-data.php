...
<body>
	...
	<div class="container mt-5 border" style="width: 800px;">
		<h3 class="mt-4 mb-4">Tambah Data Barang</h3>
		<form method="post" action="simpan.php">
			<div class="form-group row">
				<label for="no" class="col-sm-2 col-form-label">No</label>
				<div class="col-sm-10">
					<input type="hidden" onkeyup="isi_otomatis()" name="no" readonly="" class="form-control">
				</div>
			</div>
			<div class="form-group row">
